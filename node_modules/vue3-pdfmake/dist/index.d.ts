...
declare type PageSize = PredefinedPageSize | CustomPageSize;
...
declare type PredefinedPageSize = '4A0' | '2A0' | 'A0' | 'A1' | 'A2' | 'A3' | 'A4' | 'A5' | 'A6' | 'A7' | 'A8' | 'A9' | 'A10' | 'B0' | 'B1' | 'B2' | 'B3' | 'B4' | 'B5' | 'B6' | 'B7' | 'B8' | 'B9' | 'B10' | 'C0' | 'C1' | 'C2' | 'C3' | 'C4' | 'C5' | 'C6' | 'C7' | 'C8' | 'C9' | 'C10' | 'RA1' | 'RA2' | 'RA3' | 'RA4' | 'SRA1' | 'SRA2' | 'SRA3' | 'SRA4' | 'EXECUTIVE' | 'FOLIO' | 'LEGAL' | 'LETTER' | 'TABLOID';
declare type PageOrientation = 'portrait' | 'landscape';
declare type PageBreak = 'before' | 'after';
declare type Size = number | 'auto' | '*' | string;
...
declare type DynamicContent = (currentPage: number, pageCount: number, pageSize: ContextPageSize) => Content | null | undefined;
declare type DynamicBackground = (currentPage: number, pageSize: ContextPageSize) => Content | null | undefined;
declare type Margins = number | [number, number] | [number, number, number, number];
declare type Decoration = 'underline' | 'lineThrough' | 'overline';
declare type DecorationStyle = 'dashed' | 'dotted' | 'double' | 'wavy';
declare type Alignment = 'left' | 'right' | 'justify' | 'center';
declare type DynamicRowSize = (row: number) => number | 'auto';
...
declare type DynamicLayout<T> = (rowIndex: number, node: ContentTable, columnIndex: number) => T | null | undefined;
interface LineStyle {
    dash?: {
        length: number;
...
declare type TableCell = {} | (Content & {
...
declare type PredefinedTableLayout = 'noBorders' | 'headerLineOnly' | 'lightHorizontalLines';
declare type TableLayout = string | PredefinedTableLayout | CustomTableLayout;
interface Style {
    /** name of the font */
...
declare type Content = string | ArrayOfContent | ContentText | ContentColumns | ContentStack | ContentUnorderedList | ContentOrderedList | ContentTable | ContentAnchor | ContentPageReference | ContentTextReference | ContentToc | ContentTocItem | ContentImage | ContentSvg | ContentQr | ContentCanvas;
interface ArrayOfContent extends Array<Content> {
}
interface ContentText extends ContentLink, ContentBase {
    text: Content;
}
interface ContentColumns extends ContentBase {
    columns: Column[];
}
...
interface ContentOrderedList extends ContentBase {
...
interface ContentUnorderedList extends ContentBase {
    ul: UnorderedListElement[];
    type?: UnorderedListType | undefined;
    markerColor?: string | undefined;
}
interface ContentCanvas extends ContentBase {
    canvas: CanvasElement[];
}
interface ContentSvg extends ContentBase {
    svg: string;
    width?: number | undefined;
    height?: number | undefined;
    fit?: [number, number] | undefined;
}
interface ContentImage extends ContentLink, ContentBase {
    image: string;
    width?: number | undefined;
    height?: number | undefined;
    fit?: [number, number] | undefined;
...
interface ContentTable extends ContentBase {
    table: Table;
    layout?: TableLayout | undefined;
}
interface ContentAnchor extends ContentBase {
    text: string | ContentAnchor;
    id: string;
}
interface ContentTocItem extends ContentBase {
...
interface ContentPageReference extends ContentBase {
    pageReference: string;
}
interface ContentTextReference extends ContentBase {
    textReference: string;
}
interface ContentToc extends ContentBase {
    toc: TableOfContent;
}
interface ContentQr extends ContentBase {
    qr: string;
...
declare type Column = Content & {
    width?: Size | undefined;
};
declare type OrderedListType = 'lower-alpha' | 'upper-alpha' | 'lower-roman' | 'upper-roman' | 'none';
declare type OrderedListElement = Content & {
    counter?: number | undefined;
    listType?: OrderedListType | undefined;
};
declare type UnorderedListType = 'square' | 'circle' | 'none';
declare type UnorderedListElement = Content & {
    listType?: UnorderedListType | undefined;
};
declare type CanvasElement = CanvasRect | CanvasPolyline | CanvasLine | CanvasEllipse;
...
declare type ImageAlignment = 'left' | 'right' | 'center';
declare type ImageVerticalAlignment = 'top' | 'bottom' | 'center';
...
declare const usePDF: () => PDFHook;

declare const setFonts: (fonts: TFontDictionary) => void;

declare const Key: InjectionKey<PDFHook>;

export { Key, PDFPlugin as default, setFonts, usePDF };
