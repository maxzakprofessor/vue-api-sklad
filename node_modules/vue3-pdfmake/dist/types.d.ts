...
export declare type fonts = TFontDictionary;
export declare type tableLayouts = {
    [name: string]: CustomTableLayout;
};
export declare type createPdf = (documentDefinitions: TDocumentDefinitions, tableLayouts?: {
    [name: string]: CustomTableLayout;
...
export declare type PageSize = PredefinedPageSize | CustomPageSize;
...
export declare type PredefinedPageSize = '4A0' | '2A0' | 'A0' | 'A1' | 'A2' | 'A3' | 'A4' | 'A5' | 'A6' | 'A7' | 'A8' | 'A9' | 'A10' | 'B0' | 'B1' | 'B2' | 'B3' | 'B4' | 'B5' | 'B6' | 'B7' | 'B8' | 'B9' | 'B10' | 'C0' | 'C1' | 'C2' | 'C3' | 'C4' | 'C5' | 'C6' | 'C7' | 'C8' | 'C9' | 'C10' | 'RA1' | 'RA2' | 'RA3' | 'RA4' | 'SRA1' | 'SRA2' | 'SRA3' | 'SRA4' | 'EXECUTIVE' | 'FOLIO' | 'LEGAL' | 'LETTER' | 'TABLOID';
export declare type PageOrientation = 'portrait' | 'landscape';
export declare type PageBreak = 'before' | 'after';
export declare type Size = number | 'auto' | '*' | string;
...
export declare type DynamicContent = (currentPage: number, pageCount: number, pageSize: ContextPageSize) => Content | null | undefined;
export declare type DynamicBackground = (currentPage: number, pageSize: ContextPageSize) => Content | null | undefined;
export declare type Margins = number | [number, number] | [number, number, number, number];
export declare type Decoration = 'underline' | 'lineThrough' | 'overline';
export declare type DecorationStyle = 'dashed' | 'dotted' | 'double' | 'wavy';
export declare type Alignment = 'left' | 'right' | 'justify' | 'center';
export declare type DynamicRowSize = (row: number) => number | 'auto';
...
export declare type DynamicLayout<T> = (rowIndex: number, node: ContentTable, columnIndex: number) => T | null | undefined;
...
export declare type TableCell = {} | (Content & {
...
export declare type PredefinedTableLayout = 'noBorders' | 'headerLineOnly' | 'lightHorizontalLines';
export declare type TableLayout = string | PredefinedTableLayout | CustomTableLayout;
...
export declare type Content = string | ArrayOfContent | ContentText | ContentColumns | ContentStack | ContentUnorderedList | ContentOrderedList | ContentTable | ContentAnchor | ContentPageReference | ContentTextReference | ContentToc | ContentTocItem | ContentImage | ContentSvg | ContentQr | ContentCanvas;
...
export declare type Column = Content & {
    width?: Size | undefined;
};
export declare type OrderedListType = 'lower-alpha' | 'upper-alpha' | 'lower-roman' | 'upper-roman' | 'none';
export declare type OrderedListElement = Content & {
    counter?: number | undefined;
    listType?: OrderedListType | undefined;
};
export declare type UnorderedListType = 'square' | 'circle' | 'none';
export declare type UnorderedListElement = Content & {
    listType?: UnorderedListType | undefined;
};
export declare type CanvasElement = CanvasRect | CanvasPolyline | CanvasLine | CanvasEllipse;
...
export declare type ImageAlignment = 'left' | 'right' | 'center';
export declare type ImageVerticalAlignment = 'top' | 'bottom' | 'center';
...
export declare type PDFVersion = '1.3' | '1.4' | '1.5' | '1.6' | '1.7' | '1.7ext3';
