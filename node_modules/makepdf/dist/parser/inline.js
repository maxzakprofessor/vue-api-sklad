...
export function parseInline(text, outer, props) {
    ...
    function parseUntil(ctx, expect, props) {
        ...
        const flush = () => {
            if (s)
                result.push(props ? { ...props, text: s } : s);
            s = "";
        };
        const move = (r) => {
            if (r)
...
export function asTextNode(content, props) {
    let result = { text: "" };
    if (content) {
...
export function flattenText(text, separator) {
